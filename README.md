...
| Lazy Queries                            | ❌        | Queries are sent directly, when the operation function is awaited.                                                 |
| Lazy Mutations                          | ❌        | Mutations are sent directly, when the operation function is awaited.                                               |
